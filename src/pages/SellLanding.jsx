    ...
    <div className="min-h-screen bg-[#080808] text-white">
      ...
      <section className="py-12 md:py-24 px-4 md:px-16 max-w-7xl mx-auto border-t border-white/10">
        <div className="bg-white/5 border border-white/10 rounded-3xl md:rounded-[3rem] p-8 md:p-20 text-center relative overflow-hidden flex flex-col items-center">
          ...
          <div className="w-16 h-16 md:w-20 md:h-20 bg-primary/20 text-primary rounded-full flex items-center justify-center mb-6 md:mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Link 
              to="/dashboard"
              className="bg-primary text-[#080808] px-6 md:px-8 py-3 md:py-4 rounded-full font-bold text-base md:text-lg hover:bg-primary/90 transition-transform active:scale-95 flex items-center justify-center gap-2 w-full md:w-auto"
            >
