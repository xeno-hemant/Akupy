              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex items-center gap-6">
                    <div className="w-14 h-14 bg-green-50 text-primary rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-600 font-medium flex items-center gap-1 mt-1"><TrendingUp className="w-3 h-3" /> Based on simulation</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm flex items-center gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-purple-500 font-medium flex items-center gap-1 mt-1">This month</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="pt-2 flex items-center gap-4">
                  <button 
                    type="submit"
                    disabled={saveStatus === 'saving'}
                    className="bg-[#080808] text-white font-semibold px-8 py-3 rounded-full hover:bg-black/80 transition-transform active:scale-95 disabled:opacity-70"
                  >
                    {saveStatus === 'saving' ? 'Saving...' : 'Save Changes'}
                  </button>
                  {saveStatus === 'success' && <span className="text-green-600 font-medium text-sm">Updated successfully!</span>}
                  {saveStatus === 'error' && <span className="text-red-600 font-medium text-sm">Error updating profile.</span>}
                </div>
              </form>
