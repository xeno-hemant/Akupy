                        ...
                        <div className="mb-12 pt-6" style={{ borderTop: `1px solid ${HH.silver}` }}>
                            ...
                            {detailsExpanded && (
                                <div className="text-sm font-medium leading-relaxed space-y-4" style={{ color: textSub }}>
                                    ...
                                    {/* Chat CTA inside description */}
                                    {!incog && (
                                        <div className="pt-2 border-t" style={{ borderColor: HH.silver }}>
                                            <button
                                                onClick={handleChat}
                                                className="flex items-center gap-2 px-4 py-2.5 rounded-full text-sm font-bold transition-all active:scale-95 shadow-sm"
